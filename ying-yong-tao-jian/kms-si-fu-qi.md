...
cd Linux/arm/little-endian/static
cp vlmcsd-armv7el-uclibc-static kms && mv kms /usr/bin
...
{% tabs %}
{% tab title="2019.10.14" %}
## [vlmcsd](http://wind4.github.io/vlmcsd/)

## Microsoft KMS Activation <a id="microsoft-kms-activation"></a>
...
#### Windows 8 / 8.1 <a id="windows-8--81"></a>
...
#### Windows Server 2012 <a id="windows-server-2012"></a>
...
#### Windows Server 2008 <a id="windows-server-2008"></a>
...
#### Office 2019 <a id="office-2019"></a>
...
#### Office 2016 <a id="office-2016"></a>
...
#### Office 2013 <a id="office-2013"></a>
...
#### Office 2010 <a id="office-2010"></a>
